    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSave} className="glass-card p-6 space-y-6">
        <div className="flex items-center gap-4 pb-6 border-b border-slate-200 dark:border-slate-700">
          ...
          <div>
            <h2 className="font-semibold text-slate-900 dark:text-white">{name || 'Sua Empresa'}</h2>
            <p className="text-xs text-slate-500">Plano: <span className="font-medium capitalize">{tenant?.plan ?? 'free'}</span></p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="mb-1.5 block text-sm font-medium text-slate-700 dark:text-slate-300">Nome da empresa</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-slate-700 dark:text-slate-300">Domínio corporativo</label>
            <input
              type="text"
              value={domain}
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-slate-700 dark:text-slate-300">URL do Logo</label>
            <input
              type="url"
              value={logoUrl}
